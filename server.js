...
const PORT_HTTP  = parseInt(process.env.NMS_PORT)  || 8080;  // node-media-server HTTP
const PORT_API   = parseInt(process.env.PORT)       || 8888;  // Express API + 대시보드
...
httpServer.listen(PORT_API, '0.0.0.0', function() {
  ...
  console.log('  NMS HTTP:   http://' + ip + ':' + PORT_HTTP + ' (node-media-server 내부)');
